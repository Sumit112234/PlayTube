...
const About = () => {
  return (
    <div> <div className="container mx-auto py-4 px-6 bg-green-200 font-serif ">
    ...
    <p className="text-lg mb-4">
      Thank you for visiting our About page and learning more about our project. If you have any questions or feedback, feel free to ask on <p className='text-blue-500'>Sumitbaghel22@gmail.com, rohan.baghel.786@gmail.com.</p>
    </p>
  </div></div>
  )
}
